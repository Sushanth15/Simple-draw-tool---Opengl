...
void mouse(int btn, int state, int x, int y)
{
	...
	else
	{
		...
		if (btn == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
		{
			...
			{
				if (linePoints[i].getx() > x - 30 && linePoints[i].getx() < x + 30 && linePoints[i].gety() > y - 30 && linePoints[i].gety() < y + 30)
				{
					cout << "foundrthepoint";
			...
			if (!foundpoint)
			{
				...
				{
					if (rectPoints[i].getx() > x - 30 && rectPoints[i].getx() < x + 30 && rectPoints[i].gety() > y - 30 && rectPoints[i].gety() < y + 30)
					{
						cout << "foundrthepoint";
			...
			if (!foundpoint)
			{
				...
				{
					if (circlePoints[i].getx() > x - 30 && circlePoints[i].getx() < x + 30 && circlePoints[i].gety() > y - 30 && circlePoints[i].gety() < y + 30)
					{
						cout << "foundrthepoint";
			...
			if (!foundpoint)
			{
				for (int i = 0; i < polygonPoints.size(); i++)
				{
					if (polygonPoints[i].getx() > x - 30 && polygonPoints[i].getx() < x + 30 && polygonPoints[i].gety() > y - 30 && polygonPoints[i].gety() < y + 30)
					{
						cout << "foundrthepoint";
